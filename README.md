...
Visited Page Tracker is a local-only Chrome Extension Manifest V3 project that records page visits and places a red **SEEN** tag on pages that existed in the selected visit database before the current navigation.
...
2. Confirm no SEEN tag appears.
3. Reload the page.
4. Confirm the red SEEN tag appears.
